...
#define VERSION_MAJOR 33     /* A positive integer; Number(s) after possible decimal point are ignored */
#define VERSION_MINOR 1.007  /* Four digits precision/three decimal points (e.q. 2.068) here, please */
